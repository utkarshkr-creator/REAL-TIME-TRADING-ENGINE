...
(0, vitest_1.describe)("orderbook test", () => {
    (0, vitest_1.it)("Empty orderbook should not filled", () => {
    ...
    (0, vitest_1.it)("check orderbook", () => {
        ...
        const { fills, executedQty } = orderbook.addOrder(order);
        (0, vitest_1.expect)(fills.length).toBe(1);
        (0, vitest_1.expect)(executedQty).toBe(2);
        (0, vitest_1.expect)(orderbook.bids.length).toBe(2);
        (0, vitest_1.expect)(orderbook.asks.length).toBe(0);
    });
});
(0, vitest_1.describe)("Self trade preventation", () => {
    (0, vitest_1.it)("User cant self trade", () => {
        const orderbook = new Orderbook_1.Orderbook("TATA", [{
                price: 999,
                quantity: 1,
                orderId: "1",
...
(0, vitest_1.describe)("Precission errors are taken care of", () => {
    ...
    vitest_1.it.todo("Bid doesnt persist even with decimals", () => {
        ...
        const { fills, executedQty } = orderbook.addOrder(order);
        (0, vitest_1.expect)(fills.length).toBe(1);
        (0, vitest_1.expect)(executedQty).toBe(0.551123);
