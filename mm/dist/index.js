...
async function getMidPrice() {
    var _a, _b, _c, _d;
    try {
        const resp = await axios_1.default.get(`${BASE_URL}/api/v1/depth?symbol=${MARKET}`, { timeout: 2000 });
...
async function getOpenOrders(userId) {
    try {
        const resp = await axios_1.default.get(`${BASE_URL}/api/v1/order/open?userId=${userId}&market=${MARKET}`, { timeout: 2000 });
...
async function cancelOrder(orderId) {
    try {
        await axios_1.default.delete(`${BASE_URL}/api/v1/order`, {
...
async function placeOrder(side, humanPrice, humanQty, userId) {
    var _a, _b;
    try {
        await axios_1.default.post(`${BASE_URL}/api/v1/order`, {
            market: MARKET,
